...
const Behruzjon_skills = ['Time management', 'presentation', 'design', 'Data analyzing', 'Creativity & Imaginative thinking',  'Critical thinking and problem solving', 'Charismatic & Enthusistic', 'Coding', 'Teamwork', 'word processing' ];
// const Behruzjon_skills = ['word processing', 'presentation', 'design', 'Teamwork', 'Time management', 'Critical thinking and problem solving', 'Creativity & Imaginative thinking', 'Charismatic & Enthusistic', 'Data analyzing', 'Coding'];
// const colors = ['#660000', '#CC3399', '#FF9933', '#fdae61', '#fee08b', '#e6f598', '#abdda4', '#66c2a5', '#3288bd', '#5e4fa2'];
...
let draw = function () {
  ...
  svg.append("g").attr("class", "labels"); // text of labels
  ...
  attr('dy', '0.35em').
  style("opacity", 0).
  style('fill', (d, i) => colors[i]). // colors of labels
  // text((d, i) => colors[i]).
  // style('fill', (d, i) => Behruzjon_skills[i]).
  text((d, i) => Behruzjon_skills[i]). // texts in labels
  attr('transform', d => {
